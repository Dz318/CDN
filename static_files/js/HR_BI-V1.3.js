...
layui.use('laydate', function(){
	...
	var myChart = echarts.init(total_container,'dark');
	var app = {};
				...
				geo: {
					...
					tooltip: {
						...
						formatter: (p) => {
							...
							let txtCon =
								"<div style='text-align:left;font-size:30px'>" + p.name + ':<br />人员数量：' + val.toFixed(0) + '</div>';
							return txtCon;
						},
					},
					label: {
	...
	var myChart = echarts.init(unit_container_dom,'dark',chat_size);
	var app = {};
	...
	var myChart = echarts.init(dom,'dark',chat_size);
