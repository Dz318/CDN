...
layui.use('laydate', function(){
	...
	unit_container_option = {
	    ...
	    xAxis: {
	        type: 'category',
	        name:'分公司',
	        data: ['公司总部','基础设施事业部', '西南分', '华东分', '山东分', '江苏分', '河南分','安徽分','南方分','菲律宾分'],
			axisLabel:{
				interval:0
			}
	    },
	...
	personnel_allocation_option = {
	    ...
	    xAxis: {
	        ...
	        data: ['基础设施事业部','西南分','华东分','山东分', '江苏分', '河南分','安徽分','南方分','菲律宾分']
	    },
	    yAxis: {
	        name:'人数',
	        type: 'value'
	    ...
	    series: [
	        {
	            name: '实际人数',
	            type: 'line',
	            data: [420, 514, 647, 815, 604, 1116,787,1047,89]
	        },
	        {
	            name: '计划人员',
	            type: 'line',
	            data: [308, 420, 704, 830, 548, 1256,698,987,78]
	        }
	    ]
	};
	    ...
	    series: [
	        {
	            name: '人均营收',
	            type: 'bar',
	            data: [545.6, 567.7, 614.4, 634.32, 673.2, 627.3, 609.8, 685.3, 714.4],
	            markPoint: {
	                data: [
	                    {type: 'max', name: '最大值'},
	                    {type: 'min', name: '最小值'}
	        ...
	        },
	        {
	            ...
	            type: 'line',
				yAxisIndex: 1,
	            data: [11.6, 13.9, 14.4, 14.87, 15.7, 15.9, 16.6, 17.2, 17.5],
	            label:{
	                show:true,
	                position:'top',
					formatter:"{c}%"
	    ...
	    series: [
	        {
	            name: '工资利润率',
	            type: 'line',
	            data: [11.8, 12.7, 13.5, 13.8, 14.1, 14.25, 14.98,15.14,16.05],
	            label:{
	                show: true,
	                position:'top'
	            },
	        ...
	        },
	        {
	            name: '工资产值率',
	            type: 'line',
	            data: [40.59, 42.38, 43.79, 45.55, 46.17, 47.08, 47.96,48.56,50.89],
	            label:{
	                show: true,
	                position:'top'
	            },
	    ...
	    series: [
	        {
	            name: '基本工资',
	            type: 'bar',
	            data: [581,1054,1139,749,1154,1191,932,990,1033],
	            markLine: {
	                data: [
	                    {type: 'average', name: '平均值'}
	                ]
	        ...
	        },
	        {
	            name: '绩效工资',
	            type: 'bar',
	            data: [495,322,463,329,374,428,524,600,553],
	            markLine: {
	                data: [
	                    {type: 'average', name: '平均值'}
	                ]
	        ...
	        },
	        {
	            name: '单项事项奖罚',
	            type: 'bar',
	            data: [212,256,370,228,264,222,285,296,363],
	            markLine: {
	                data: [
	                    {type: 'average', name: '平均值'}
	                ]
	        ...
	        },
	        {
	            name: '津补贴',
	            type: 'bar',
	            data: [315,313,355,310,473,428,303,483,367],
	            markLine: {
	                data: [
	                    {type: 'average', name: '平均值'}
	                ]
	        ...
	        },
	        {
	            name: '效益奖金',
	            type: 'bar',
	            data: [1692,1137,1330,1560,1629,1260,1755,1662,1361],
	            markLine: {
	                data: [
	                    {type: 'average', name: '平均值'}
	                ]
	    ...
	    series: [
	        {
	            name: '月平均薪酬',
	            type: 'bar',
	            data: [6059,4704,6196,5709,6371,5933,5157,4738,4933],
	            markLine: {
	                data: [
	                    {type: 'average', name: '平均值'}
	                ]
	        ...
	        },
	        {
	            name: '年平均薪酬',
	            type: 'bar',
	            data: [87938,79849,89032,80106,93809,71016,70767,93948,85607],
	            markLine: {
	                data: [
	                    {type: 'average', name: '平均值'}
	                ]
	    ...
	    series: [
	        {
	            name: '25分位值',
	            type: 'line',
	            data: [3960,2603,3178,3176,3555,2888,3624,2623,4115],
	            markPoint: {
	                data: [
	                    {type: 'max', name: '最大值'},
	                    {type: 'min', name: '最小值'}
	        ...
	        },
	        {
	            name: '50分位值',
	            type: 'line',
	            data: [6647,6561,6262,6871,5580,6234,4172,4786,5931],
	            markPoint: {
	                data: [
	                    {type: 'max', name: '最大值'},
	                    {type: 'min', name: '最小值'}
	        ...
	        },
	        {
	            name: '75分位值',
	            type: 'line',
	            data: [7796,7866,8286,8732,6244,7499,9440,8193,9694],
	            markPoint: {
	                data: [
	                    {type: 'max', name: '最大值'},
	                    {type: 'min', name: '最小值'}
	    ...
	    series: [
	        {
	            name: '数量',
	            type: 'bar',
	            data: [95,39,124,87,132,261,181,107,184,0],
	            label:{
	                show:true,
	                position:'right'
	            },
	    ...
	    series: [
	        {
	            name: '数量',
	            type: 'bar',
	            data: [12,35,64,64,70,50,46,39,39,6],
	            label:{
	                show:true,
	                position:'right'
	            },
